...
const useDblpAuthor = (author_name: string) => {
    return useQuery({ queryKey: ["author_dblp", author_name], queryFn: () => getAuthorDBLP(author_name), staleTime: 60 * 60 * 1000 })
}
...
const DblpProfileRedirectButton = (props: DblpProfileRedirectButtonProps) => {
    ...
    const DblpIcon = (props: Partial<CustomIconComponentProps>) => (
                    ...
                    <div
                        ...
                        <List
                            ...
                            renderItem={(author, index) => (
                                <List.Item onClick={() => window.open(author.dblp_url, '_blank')} className='authorListItem'>
